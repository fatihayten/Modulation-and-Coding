...
index =2000; % non-critical parameter for scatterplots
desired_snr = 15; % again, for scatterplots
desired_ppm = 10; % again, for scatterplots
fc = 2e+9; % carrier frquency

cfo = ppm*1e-6*fc; % CFO

f_cut = 1e6; % cutoff frequency
F_sampling = 8e6; 
T_sampling = 1/F_sampling;
F_symbol =2*f_cut; %symbol frequency
T_symbol = 1/F_symbol;
upsample_rate = F_sampling/F_symbol;
rand_phase = 1/8; %Phase of CFO, will be multiplied with 2*pi afterwards
